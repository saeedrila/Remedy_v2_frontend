...
const FETCH_DASHBOARD_DATA = '/fetch-lab-dashboard-data'

function Dashboard({ triggerFetch }) {
  const [labDashboardData, setLabDashboardData] = useState({})
              ...
              <Row className="no-gutters align-items-center">
                <Col md={10}>
                  <CardBody>
                    ...
                    <CardText>
                      {labDashboardData.total_appointments_catered}
                    </CardText>
                  </CardBody>
                </Col>
                <Col md={2}>
              ...
              <Row className="no-gutters align-items-center">
                <Col md={10}>
                  <CardBody>
                    ...
                    <CardText>
                    ₹ {labDashboardData.total_staff_payment_last_week}
                    </CardText>
                  </CardBody>
                </Col>
                <Col md={2}>
            ...
            <Card>
              <CardBody>
                ...
                <CardText>
                  ...
                  <Row>
                    ...
                    <p>
                    {labDashboardData.total_appointments_today}
                    </p>
                    </Col>
                    <Col sm={6} className='text-center fs-4'>
                    {labDashboardData.total_appointments_today_completed}/
                    {labDashboardData.total_appointments_today}
                    </Col>
                  </Row>
                  </Container>
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">
                  ...
                  <div >
                    <Progress
                      value={labDashboardData.total_appointment_today_completed_perc}
                      color="primary"
                      style={{ width: '100%' }}
                      animated
                    ></Progress>
